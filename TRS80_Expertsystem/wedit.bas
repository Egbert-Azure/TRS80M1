...
410 NEXT N%
420 IF CO%=0 THEN GOTO 460
430 FOR N%=1 TO CO%
440 INPUT #1,CN$(1,N%):INPUT #1,CN$(2,N%):INPUT #1,CS%(N%)
450 NEXT N%
460 IF NQ%=0 THEN GOTO 480
...
1080 I$=INKEY$: IF I$="" THEN GOTO 1080
1090 PRINT I$
1100 IF I$="1" THEN GOTO 2000
1110 IF I$="2" THEN GOTO 5000
1120 IF I$="3" THEN GOTO 8000
1130 IF I$="4" THEN GOTO 10000
...
2080 I$=INKEY$:IF I$="" THEN GOTO 2080
2090 PRINT I$
2100 IF I$="1" THEN GOTO 2200
2110 IF I$="2" THEN GOTO 2600
2120 IF I$="3" THEN GOTO 2800
2130 IF I$="4" THEN GOTO 12000
2140 PRINT @ 603," ":GOTO 2070
2200 'Frage hinzuf}gen
2210 GOSUB 4000
2220 IF FRAGEN%=MFRAGEN% THEN GOTO 11000
...
2760 I$=INKEY$:IF I$="" THEN GOTO 2760
2770 IF (I$="E" OR I$="e") THEN GOTO 1000
2780 NEXT N%
2790 GOTO 1000
2800 'Frage l|schen
2810 CLS
...
2840 IF N%<=FRAGEN% THEN GOTO 2890
2850 PRINT @584,"***** Fragennummer zu gro~ *****"
2860 PRINT @651,"Bitte eine Taste dr}cken"
2870 I$=INKEY$:IF I$="" THEN GOTO 2870
2880 GOTO 1000
2890 IF NQ%=0 THEN GOTO 2930
2900 FOR M%=1 TO NQ%
...
3000 I$=INKEY$:IF I$="" THEN GOTO 3000
3010 IF (I$<>"j" AND I$<>"J") THEN FRAGEN%=FRAGEN%-1:GOTO 1000
3020 IF N%=FRAGEN% THEN GOTO 3090
...
5070 I$=INKEY$:IF I$="" THEN GOTO 5070
5080 PRINT I$
5090 IF I$="1" THEN GOTO 5200
5100 IF I$="2" THEN GOTO 5800
5110 IF I$="3" THEN GOTO 6100
5120 PRINT @603," ":GOTO 5060
5200 'Regeln hinzuf}gen
5210 GOSUB 7000
5220 IF REGELN%=MR% THEN GOTO 11000
...
5280 PRINT @217,"";:INPUT W$(1):W$=W$(1):GOSUB 5680
...
5630 U$=LEFT$(OBJEKT$,6):GOSUB 20000:IF U$<>"NICHT" THEN RETURN
...
5710 U$=W$:GOSUB 20000:IF U$<>"ODER" THEN RETURN
5720 W$(1)="- oder -"
5730 RETURN
5800 'Regeln auflisten
5810 CLS
5820 IF REGELN%<>0 THEN GOTO 5870
5830 PRINT @389,"*** keine Regeln in der Wissensbasis ***"
5840 PRINT @588,"Bitte eine Taste dr}cken"
5850 I$=INKEY$:IF I$="" THEN GOTO 5850
5860 GOTO 1000
...
6010 I$=INKEY$:IF I$="" THEN GOTO 6010
6020 IF (I$="E" OR I$="e") THEN GOTO 1010
6030 NEXT N%
6040 GOTO 1010
6100 'Regeln l|schen
6110 CLS
...
6140 IF N%<=REGELN% THEN GOTO 6190
...
6310 I$=INKEY$:IF I$="" THEN GOTO 6310
6320 IF (I$<>"j" AND I$<>"J") THEN GOTO 1000
6330 PRINT @787,"--- Bitte warten ---"
6340 FOR K%=1 TO 5
6350 OBJEKT$=WENN$(K%,N%):GOSUB 7110
6360 NEXT K%
6370 OBJEKT$=DANN$(N%):GOSUB 7110
6380 IF N%=REGELN% THEN GOTO 6460
...
7230 IF OA$(M%)=OBJEKT$ THEN GOTO 7260
7240 NEXT M%
7250 RETURN
7260 IF N%=OBJEKTE% THEN GOTO 7320
...
8080 I$=INKEY$:IF I$="" THEN GOTO 8080
8090 PRINT I$
8100 IF I$="1" THEN GOTO 8200
8110 IF I$="2" THEN GOTO 8600
8120 IF I$="3" THEN GOTO 9000
8130 IF I$="4" THEN GOTO 9400
8140 PRINT @603," ":GOTO 8070
8200 'Objekte auflisten
8210 CLS
8220 IF OBJEKTE%<>0 THEN GOTO 8270
8230 PRINT @584,"*** keine Objekte in der Wissensbasis ***"
8240 PRINT @657,"Bitte eine Taste dr}cken"
8250 I$=INKEY$:IF I$="" THEN GOTO 8250
8260 GOTO 1000
8270 ZEILE%=2
...
8750 ZEILE%=ZEILE%+2
8760 IF ZEILE%<14 THEN GOTO 8810
8770 PRINT @904,"Bitte eine Taste dr}cken     <E>=Ende"
8780 I$=INKEY$:IF I$="" THEN GOTO 8780
8790 IF (I$="E" OR I$="e") THEN GOTO 1000
8800 CLS:ZEILE%=2
8810 NEXT N%
8820 PRINT @840,"********* Ende der Liste ********"
8830 PRINT @908,"Bitte eine Taste dr}cken"
8840 I$=INKEY$:IF I$="" THEN GOTO 8840
8850 GOTO 1000
...
9530 I$=INKEY$:IF I$="" THEN GOTO 9530
9540 PRINT @654,"--- Bitte warten ---"
9550 IF (I$<>"j" AND I$<>"J") THEN GOTO 1000
...
10190 NEXT N%
10200 IF CO%=0 THEN 10260
10210 FOR N%=1 TO CO%
10220 PRINT #1,CN$(1,N%)
10230 PRINT #1,CN$(2,N%)
10240 PRINT #1,CS%(N%)
10250 NEXT N%
10260 IF NQ%=0 THEN GOTO 10280
...
12070 I$=INKEY$:IF I$="" THEN GOTO 12070
12080 PRINT I$
12090 IF I$="1" THEN GOTO 12200
12100 IF I$="2" THEN GOTO 12600
12110 IF I$="3" THEN GOTO 13000
12120 PRINT @603," ":GOTO 12070
12200 'Eingangsfrage hinzuf}gen
12210 CLS
12220 NQ%=NQ%+1:IF NQ%>MQ% THEN GOTO 11000
...
12760 ZEILE%=ZEILE%+2
12770 IF ZEILE%<14 THEN GOTO 12820
12780 PRINT @908,"Bitte eine Taste dr}cken      <E>=Ende"
12790 I$=INKEY$:IF I$="" THEN GOTO 12790
12800 IF (I$="E" OR I$="e") THEN GOTO 1000
12810 CLS:ZEILE%=2
12820 NEXT N%
12830 PRINT @840,"******** Ende der Liste ********"
12840 PRINT @908,"Bitte eine Taste dr}cken"
12850 I$=INKEY$:IF I$="" THEN GOTO 12850
12860 GOTO 1000
